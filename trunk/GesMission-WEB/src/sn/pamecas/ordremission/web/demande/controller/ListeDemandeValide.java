...
public class ListeDemandeValide extends SelectorComposer<Component>{
			...
			try {
				if (uf.getFonction().getLibelle()
					...
					demandeModel = new ListModelList<DemandeTDR>(
							demandeService.displayTDRControleurValide());
					...
					DemandeTDRFacade demandeService = (DemandeTDRFacade) JNDIUtils
							.lookUpEJB(EJBRegistry.DemandeTDRFacade);
					demandeModel = new ListModelList<DemandeTDR>(
							demandeService.displayTDRComptableValide());
					listDemande.setModel(demandeModel);
					...
					DemandeTDRFacade demandeService = (DemandeTDRFacade) JNDIUtils
							.lookUpEJB(EJBRegistry.DemandeTDRFacade);
					demandeModel = new ListModelList<DemandeTDR>(
							demandeService.displayTDRPatrimoineValide());
					listDemande.setModel(demandeModel);
				} else if (uf.getFonction().getLibelle()
					...
					DemandeTDRFacade demandeService = (DemandeTDRFacade) JNDIUtils
							.lookUpEJB(EJBRegistry.DemandeTDRFacade);
					demandeModel = new ListModelList<DemandeTDR>(
							demandeService.displayTDRSuperviseurValide());
					listDemande.setModel(demandeModel);
				}
					...
					DemandeTDRFacade demandeService = (DemandeTDRFacade) JNDIUtils
							.lookUpEJB(EJBRegistry.DemandeTDRFacade);
					demandeModel = new ListModelList<DemandeTDR>(
							demandeService.displaytdrDRHValide());
					listDemande.setModel(demandeModel);
				} else if (uf.getFonction().getLibelle()
					...
					DemandeTDRFacade demandeService = (DemandeTDRFacade) JNDIUtils
							.lookUpEJB(EJBRegistry.DemandeTDRFacade);
					demandeModel = new ListModelList<DemandeTDR>(
							demandeService.displaytdrDGAValide());
					listDemande.setModel(demandeModel);
				} else {
					...
					DemandeTDRFacade demandeService = (DemandeTDRFacade) JNDIUtils
							.lookUpEJB(EJBRegistry.DemandeTDRFacade);
					demandeModel = new ListModelList<DemandeTDR>(
							demandeService.displayTDRValide(uf.getId()));
					listDemande.setModel(demandeModel);
				}
		...
		if (action.equalsIgnoreCase("CREER_DEMANDE")) {
			...
			if (listDemande.getSelectedItem() != null) {
				...
				if (uf.getFonction().getLibelle()
					...
					Window window = (Window) Executions.createComponents(
							"/pages/demande/ordreMissionUser.zul", getSelf(),
							params);
					window.setMode(Mode.MODAL);
				} else if (uf.getFonction().getLibelle()
						.equalsIgnoreCase("Patrimoine")) {
					Window window = (Window) Executions.createComponents(
							"/pages/demande/voir_ressourceValide.zul", getSelf(),
							params);
					window.setMode(Mode.MODAL);
				} else if (uf.getFonction().getLibelle()
						.equalsIgnoreCase("Controleur")) {
