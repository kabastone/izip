...
public class ListePatientTransfereControl extends SelectorComposer<Component> {
	...
	public void afficherdossiersoins(){
		...
		Window win=(Window) Executions.createComponents("/pages/page_soins/creer_dossier_soin.zul", getSelf(), null);
	...
	public void afficherdossiermed(){
		...
		Window win=(Window) Executions.createComponents("/pages/page_medical/details_dossier_medical.zul", getSelf(), null);
		win.setMode(Mode.MODAL);
	}
	...
	public void afficherdossieradmin(){
		...
		Window win=(Window) Executions.createComponents("/pages/page_administratif/dossier_administratif.zul", getSelf(), null);
		win.setMode(Mode.MODAL);
	}
